...
\item Aplicando las \emph{leyes de Newton}:
  ...
  suelo\footnotemark{}
  \footnotetext{Elegimos este punto para que el momento de dos fuerzas, el de $\vvv{N}_1$ y
    $\vvv{f}_r$ sea nulo y así reducimos el número de términos en las ecuaciones.}
...
través de una barra inclinada según se esquematiza en la figura~\ref{fig:el-barra2-geometria}.
Las fuerzas que actúan sobre ella se representan en la figura~\ref{fig:el-barra2-fuerzas}.
La fuerza aplicada es el peso $P=mg$. Debido a las características del problema, tenemos una fuerza
de ligadura sobre la partícula, que es la normal $\vvv{N}$, perpendicular a la barra.
...
Por tanto, podemos añadirlo a~\eqref{eq:el-EL-temp02}
\[
...
a lo largo del eje $x$. Ésta, a su vez está unida a otra masa $m$ por medio de una varilla
